...
console.log(Stemmer.a("mencinta").current_word);
console.log(Stemmer.a("mendua").current_word);
console.log(Stemmer.a("menjauh").current_word);
console.log(Stemmer.a("menziarah").current_word);
// FULL TESTCASES
