const knownAbbreviations = [
  ...
  "núm.", "n.º", "n°", "núms.", "n.os", "n.os.", "ud.", "uds.",
  "año.", "años.", "c/ap.", "c/u.", "s/n.", "av.", "pto.", "ptos.", "pág.", "págs.", "vol.", "vols.", "ed.", "eds.", "cap.", "caps.",
  "mín.", "máx.", "aprox.", "ant.", "sig.", "hist.", "biol.", "quím.", "mat.", "psic.",
  "adj.", "adv.", "art.", "arts.", "vb.", "vbs.", "sust.", "susts.", "prep.", "preps.",

  // Legal written in Spanish
  "Art.", "arts.", "Inc.", "incs.", "ley.", "leys.", "const.", "Cód.", "Códs.",
  "C.C.", "C.P.", "C.N.", "DNU.", "DTO.", "Res.", "Res.", "Disp.", "Disps.",
