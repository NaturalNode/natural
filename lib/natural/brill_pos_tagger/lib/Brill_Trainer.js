...
function Brill_Trainer() {

}

// Initial tagging of the corpus to bootstrap the learning algorithm
Brill_Trainer.prototype.tagCorpusInitially = function(lexicon) {
...
Brill_Trainer.prototype.selectHighRule = function() {
...
Brill_Trainer.prototype.scanForPositiveRules = function() {
  var that = this;
...
// update the scores
Brill_Trainer.prototype.scanForSites = function() {
  this.corpus.sentences.forEach(function(sentence, i) {
    sentence.forEach(function(token, j) {
      Object.keys(this.rules).forEach(function(key) {
...
Brill_Trainer.prototype.train = function(corpus, templates, lexicon) {
  this.corpus = corpus;
