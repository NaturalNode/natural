...
Spellcheck.prototype.getCorrections = function(word, maxDistance) {
    ...
    var self = this;
    return this.editsWithMaxDistance([word], maxDistance).filter(function(word) { return self.isCorrect(word); })
...
Spellcheck.prototype.editsWithMaxDistance = function(words, depth) {
    ...
    deeper = deeper.concat(this.editsWithMaxDistance(deeper,depth-1));
    return deeper;
}
